...
public object ArmPidSource: PIDSource//the object that the PID controller checks while it is being run on the other thread
{
    ...
    {
        return (Arm.getEncoderRawArm())//runs this function whenever the pid loop is called and takes the value as the input into the pid loop
    }
}
