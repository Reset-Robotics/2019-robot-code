...
public object PIDSourceX : PIDSource//the object that the PID controller checks while it is being run on the other thread
{
    ...
    override fun pidGet(): Double = return (Drivetrain.rotatedXVelocity); // Runs this function whenever the pid loop is called and takes the value as the input into the pid loop
}
