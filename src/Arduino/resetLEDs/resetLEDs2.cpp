...
void resetLEDs2::color_chase(uint8_t wait, uint8_t len, uint8_t groups, uint8_t distance, grbw main, grbw Background) {
  ...
  for (int led_number = -len - groups * distance; led_number < _numPixels2 + len - 1; led_number++) {
